...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedSenders() {
        ...
        senderRepository.save(Sender.builder().name("Licenciatura en Informatica").campus("Campus Central").build());
        senderRepository.save(Sender.builder().name("Coordinacion de Posgrado").campus("Campus Central").build());
        senderRepository.save(Sender.builder().name("Instituto de Investigacion").campus("Campus Sur").build());
        senderRepository.save(Sender.builder().name("Departamento de Extension Universitaria").campus("Campus Central").build());
        System.out.println("Emisores creados");
    }

    private void seedReceivers() {
        if (receiverRepository.count() > 0) return;
        receiverRepository.save(Receiver.builder().name("Juan").lastName("Perez").twoLastName("Garcia").phone("5551234567").email("juan.perez@example.com").academicGrade("Licenciatura").build());
        ...
        receiverRepository.save(Receiver.builder().name("Ana").lastName("Gonzalez").twoLastName("Sanchez").phone("5554443322").email("ana.gonzalez@example.com").academicGrade("Licenciatura").build());
        ...
        receiverRepository.save(Receiver.builder().name("Pedro").lastName("Morales").twoLastName("Vega").phone("5558889900").email("pedro.morales@example.com").academicGrade("Licenciatura").build());
